    ...
    <div x-show="{{ $modalOpen }}" x-cloak x-transition.opacity style="background-color: rgba(0,0,0,0.6);"
        ...
        <div @click.away="modalOpen = false" x-transition.scale
            ...
            <div class="flex items-center justify-between mb-5">
                ...
                <h2 class="text-2xl font-bold text-gray-100"> Sửa màu sắc</h2>
            ...
            <!-- Form -->
            <form action="{{ route('ms.sua', $mausac->MMS) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <label for="TENMAU" class="block text-gray-200 mb-1">Tên màu:</label>
                    </div>
                    <div class="relative">
                        ...
                        <input type="text" id="TENMAU" name="TENMAU"
                            value="{{ old('TENMAU', $mausac->TENMAU) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea id="MOTA" name="MOTA" rows="3"
                            class="w-full pl-10 px-3 py-2 rounded bg-gray-800 text-gray-100 border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ old('MOTA', $mausac->MOTA) }}</textarea>
                    </div>
                </div>
