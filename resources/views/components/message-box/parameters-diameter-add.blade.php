<!-- Modal thêm thông số đường kính -->
<div>
    <div x-show="modalOpen" x-cloak x-transition.opacity style="background-color: rgba(0,0,0,0.6);"
        ...
        <div @click.away="modalOpen = false" x-transition.scale
            ...
            <div class="flex items-center justify-between mb-5">
                ...
                <h2 class="text-2xl font-bold text-gray-100">Thêm thông số đường kính</h2>
            ...
            <!-- Form -->
            <form action="{{ route('duongkinh-sp.them') }}" method="POST" id="addDiameterForm" class="space-y-4">
                @csrf
                <!-- Chỉ số -->
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="CHISO" name="CHISO"
                            ...
                            placeholder="Nhập chỉ số..." required />
                    </div>
                </div>
