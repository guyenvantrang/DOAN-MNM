<!-- Modal sửa công nghệ chống nước -->
<div>
    <div x-show="{{ $modalOpen }}" x-cloak x-transition.opacity style="background-color: rgba(0,0,0,0.6);"
        ...
        <div @click.away="modalOpen = false" x-transition.scale
            ...
            <div class="flex items-center justify-between mb-5">
                ...
                <h2 class="text-2xl font-bold text-gray-100"> Sửa công nghệ chống nước</h2>
            ...
            <!-- Form -->
            <form action="{{ route('cn.sua', $congnghe->MCN) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <label for="TEN" class="block text-gray-200 mb-1">Tên công nghệ:</label>
                    </div>
                    <div class="relative">
                        ...
                        <input type="text" id="TEN" name="TEN" value="{{ old('TEN', $congnghe->TEN) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea id="MOTA" name="MOTA" rows="3"
                            class="w-full pl-10 px-3 py-2 rounded bg-gray-800 text-gray-100 border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ old('MOTA', $congnghe->MOTA) }}</textarea>
                    </div>
                </div>
