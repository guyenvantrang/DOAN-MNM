<!-- Modal thêm công nghệ chống nước -->
<div>
    <div x-show="modalOpen" x-cloak x-transition.opacity style="background-color: rgba(0,0,0,0.6);"
        ...
        <div @click.away="modalOpen = false" x-transition.scale
            ...
            <div class="flex items-center justify-between mb-5">
                ...
                <h2 class="text-2xl font-bold text-gray-100"> Thêm công nghệ chống nước</h2>
            ...
            <!-- Form -->
            <form action="{{ route('cn.them') }}" method="POST" id="addTechForm" class="space-y-4">
                @csrf
