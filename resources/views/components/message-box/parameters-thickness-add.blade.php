    ...
    <div x-show="modalOpen" x-cloak x-transition.opacity style="background-color: rgba(0,0,0,0.6);"
        ...
        <div @click.away="modalOpen = false" x-transition.scale
            ...
            <div class="flex items-center justify-between mb-5">
                ...
                <h2 class="text-2xl font-bold text-gray-100"> Thêm độ dày</h2>
            ...
            <!-- Form -->
            <form action="{{ route('doday-sp.them') }}" method="POST" id="addDodayForm" class="space-y-4">
                @csrf
                <!-- Mô tả -->
                ...
                <div>
                    ...
                    <div class="relative">
                        <textarea type="text" id="MOTA" name="MOTA" rows="2"
