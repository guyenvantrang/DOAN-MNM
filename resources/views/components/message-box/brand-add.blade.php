    ...
    <div x-show="modalOpen" x-cloak x-transition.opacity style="background-color: rgba(0,0,0,0.6);"
        ...
        <div @click.away="modalOpen = false" x-transition.scale
            ...
            <div class="flex items-center justify-between mb-5">
                ...
                <h2 class="text-2xl font-bold text-gray-100"> Thêm loại sản phẩm</h2>
            ...
            <!-- Form -->
            <form action="{{ route('thuonghieu-sp.them') }}" method="POST" id="addCategoryForm" class="space-y-4">
                 @csrf
                <!-- Tên loại -->
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="TENTHUONGHIEU" name="TENTHUONGHIEU"
                ...
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <label for="QUOCGIA" class="block text-gray-200 mb-1">Quốc gia:</label>
                    </div>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400">
                            <!-- Heroicon Pencil -->
