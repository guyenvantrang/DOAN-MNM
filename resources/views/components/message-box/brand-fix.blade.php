    ...
    <div x-show="{{ $modalOpen }}" x-cloak x-transition.opacity style="background-color: rgba(0,0,0,0.6);"
        ...
        <div @click.away="modalOpen = false" x-transition.scale
            ...
            <div class="flex items-center justify-between mb-5">
                ...
                <h2 class="text-2xl font-bold text-gray-100"> Sửa thương hiệu</h2>
            ...
            <!-- Form -->
            <form action="{{ route('thuonghieu-sp.sua', $thuonghieu->MATHUONGHIEU) }}" method="POST" 
                class="space-y-4">
                <!-- Mã loại -->
                @csrf
                @method('PUT')
                ...
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <label for="TENTHUONGHIEU" class="block text-gray-200 mb-1">Tên thương hiệu:</label>
                    </div>
                    <div class="relative">
                        ...
                        <input type="text" id="TENTHUONGHIEU" name="TENTHUONGHIEU" value="{{ old('TENTHUONGHIEU', $thuonghieu->TENTHUONGHIEU) }}"
                ...
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <label for="TENTHUONGHIEU" class="block text-gray-200 mb-1">Quốc gia:</label>
                    </div>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400">
                            <!-- Heroicon Pencil -->
                        ...
                        <input type="text" id="QUOCGIA" name="QUOCGIA" value="{{ old('QUOCGIA', $thuonghieu->QUOCGIA) }}"
                            class="w-full pl-10 px-3 py-2 rounded bg-gray-800 text-gray-100 border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                    </div>
                </div>
                <!-- Mô tả -->
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea id="MOTA" name="MOTA" rows="3"
                            class="w-full pl-10 px-3 py-2 rounded bg-gray-800 text-gray-100 border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ old('MOTA', $thuonghieu->MOTA) }}</textarea>
                    </div>
                </div>
