<!-- Modal thêm thông số chiều dài dây -->
<div>
    <div x-show="modalOpen" x-cloak x-transition.opacity style="background-color: rgba(0,0,0,0.6);"
        ...
        <div @click.away="modalOpen = false" x-transition.scale
            ...
            <div class="flex items-center justify-between mb-5">
                ...
                <h2 class="text-2xl font-bold text-gray-100">Thêm thông số chiều dài dây</h2>
            ...
            <!-- Form -->
            <form action="{{ route('chieudaiday-sp.them') }}" method="POST" id="addLengthForm" class="space-y-4">
                @csrf
                <!-- Chỉ số -->
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <textarea  type="text" id="MOTA" name="MOTA"
                            class="w-full pl-3 px-3 py-2 rounded bg-gray-800 text-gray-100 border border-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-none"></textarea>
